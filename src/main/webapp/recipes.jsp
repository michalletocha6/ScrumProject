...
<section>
    <div class="row padding-small">
        ...
        <form action="/recipes" method="post">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Znajdź przepis: <input id="recipeName" placeholder="Podaj nazwe przepisu" name="recipeName">
...
<section class="mr-4 ml-4">
    <table class="table">
        ...
        <c:forEach items="${recipesSorted}" var="recipe">
            <tr class="d-flex">
                ...
                <td class="col-1"><a href="/recipe/details?id=${recipe.id}" class="btn btn-info rounded-0 text-light">Szczegóły</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
