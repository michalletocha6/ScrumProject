    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <form method="post" action='<c:url value = "/app/plan/edit"/>'>
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                    <textarea class="form-control" name="planDescription" rows="5" id="planDescription" placeholder="Opis plany">${plan.description}</textarea>
                            </div>
                        </div>
